...
with_MapTyp = 2; % (1) local mapping (faster), (2) global mapping (see note)
...
if with_BndXrs
    with_BndXrs_refine = 1; % keep refining untill intersection is imminent
...
plot_Cracks   = 0; % plot cracks at every time step
